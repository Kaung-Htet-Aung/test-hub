  ...
  const messages: Message[] = [
    {
      ...
      preview: "Your recent test results have been published. You scored 85% overall...",
      time: "2 hours ago",
      unread: true,
      starred: false,
      category: "inbox"
    },
    {
      ...
      preview: "Don't forget about our scheduled meeting tomorrow at 2 PM to discuss...",
      time: "5 hours ago",
      unread: false,
      starred: true,
      category: "inbox"
    },
    {
      ...
      preview: "Scheduled maintenance will occur this weekend. The system will be...",
      time: "1 day ago",
      unread: false,
      starred: false,
      category: "inbox"
    },
    {
      ...
      preview: "I had a question regarding the format of the upcoming assessment...",
      time: "2 days ago",
      unread: false,
      starred: false,
      category: "inbox"
  ...
  const conversations: Conversation[] = [
    {
      ...
      messages: [
        ...
        },
        {
          id: "2",
          sender: "me",
          content: "Sure, I'd be happy to help. Which test are you referring to?",
          time: "10:32 AM",
          read: true
        },
        {
          id: "3",
          sender: "them",
          content: "The Math Assessment from yesterday. I scored 78% and wanted to understand where I can improve.",
          time: "10:35 AM",
          read: true
        }
      ]
    ...
    >
        ...
        <Tabs defaultValue="inbox" className="space-y-4">
          <TabsList className="bg-gray-900 border-gray-800">
            <TabsTrigger value="inbox" className="text-gray-300 data-[state=active]:bg-gray-800">
              Inbox
              <Badge variant="secondary" className="ml-2 bg-gray-800 text-gray-300">
                {messages.filter(m => m.category === "inbox" && m.unread).length}
              </Badge>
            </TabsTrigger>
            <TabsTrigger value="sent" className="text-gray-300 data-[state=active]:bg-gray-800">
              Sent
            </TabsTrigger>
            <TabsTrigger value="drafts" className="text-gray-300 data-[state=active]:bg-gray-800">
              Drafts
            </TabsTrigger>
            <TabsTrigger value="archived" className="text-gray-300 data-[state=active]:bg-gray-800">
              Archived
            </TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-1">
                <Card className="bg-gray-900 border-gray-800 h-[600px]">
                  <CardHeader>
                    <CardTitle className="text-lg font-light text-gray-100">Messages</CardTitle>
                  </CardHeader>
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-gray-100 truncate mt-1">{message.subject}</p>
                ...
                {selectedConversation ? (
                  ...
                  <Card className="bg-gray-900 border-gray-800 h-[600px] flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-500">Choose a message from your inbox to start chatting</p>
                    </div>
                  </Card>
                )}
              </div>
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-400 mb-2">Sent Messages</h3>
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-400 mb-2">Draft Messages</h3>
                  <p className="text-sm text-gray-500">Your draft messages will appear here</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-400 mb-2">Archived Messages</h3>
                  <p className="text-sm text-gray-500">Your archived messages will appear here</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
