    ...
    learningPaths: [
      {
        ...
        description:
          "Comprehensive mathematics learning path from basics to advanced concepts",
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Let students retake tests for better scores
                  </div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Display test results right after completion
                  </div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Enforce time limits for all tests
                  </div>
                </div>
                <Switch
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Automatically create performance reports
                  </div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Add personalized feedback to reports
                  </div>
                </div>
                <Switch
              ...
              <div>
                ...
                <Select
                  value={teacherSettings.reportSettings.scheduleFrequency}
                >
                  <SelectTrigger className="bg-gray-800 border-gray-700 text-gray-100">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {teacherSettings.reportSettings.customRecipients.map(
                    (recipient, index) => (
                      <div key={index} className="flex items-center gap-2">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setTeacherSettings({
                              ...
                              reportSettings: {
                                ...teacherSettings.reportSettings,
                                customRecipients: newRecipients,
                              },
                            });
                          }}
                          className="bg-gray-800 border-gray-700 text-gray-100"
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const newRecipients =
                              teacherSettings.reportSettings.customRecipients.filter(
                                (_, i) => i !== index
                              );
                            setTeacherSettings({
                              ...teacherSettings,
                    ...
                    onClick={() => {
                      setTeacherSettings({
                        ...
                        reportSettings: {
                          ...teacherSettings.reportSettings,
                          customRecipients: [
                            ...teacherSettings.reportSettings.customRecipients,
                            "",
                          ],
                        },
                      });
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Send reminder emails before tests
                  </div>
                </div>
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setTeacherSettings({
                      ...teacherSettings,
                      reminderSettings: {
                        ...teacherSettings.reminderSettings,
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Send push notifications before tests
                  </div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Send SMS reminders before tests
                  </div>
                </div>
                <Switch
              ...
              <div>
                <label className="text-sm font-medium text-gray-400 mb-2 block">
                  Default Reminder Time (minutes before test)
                </label>
                <Input
                  type="number"
                  ...
                  onChange={(e) =>
                    setTeacherSettings({
                      ...
                      reminderSettings: {
                        ...teacherSettings.reminderSettings,
                        defaultReminderTime: parseInt(e.target.value),
                      },
                    })
                  }
                  className="bg-gray-800 border-gray-700 text-gray-100"
            ...
            <CardContent className="space-y-4">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setTeacherSettings({
                      ...teacherSettings,
                      adaptiveLearning: {
                        ...teacherSettings.adaptiveLearning,
                        enabled: checked,
                      },
                    })
                  }
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Automatically adjust question difficulty based on
                    performance
                  </div>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    Suggest additional learning materials based on progress
                  </div>
                </div>
                <Switch
