  ...
  const reports: Report[] = [
    {
      ...
      size: "2.4 MB",
      format: "pdf",
      description: "Comprehensive analysis of all test performances for January 2024"
    },
    {
      id: "2",
      ...
      {showExampleReport ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-gray-900 border-gray-800">
            ...
            <CardContent>
              <div className="text-2xl font-light text-gray-100">{reports.length}</div>
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-400">Generating</CardTitle>
        ...
        <div className="flex gap-4">
          ...
          <Card className="bg-gray-900 border-gray-800 w-64">
            <CardHeader>
              <CardTitle className="text-lg font-light text-gray-100">Filters</CardTitle>
            </CardHeader>
          ...
          <div className="flex-1">
            <Tabs defaultValue="all" className="space-y-4">
              <TabsList className="bg-gray-900 border-gray-800">
                ...
                <TabsTrigger value="completed" className="text-gray-300 data-[state=active]:bg-gray-800">
                  Completed
                </TabsTrigger>
                <TabsTrigger value="generating" className="text-gray-300 data-[state=active]:bg-gray-800">
                  Generating
                </TabsTrigger>
                <TabsTrigger value="failed" className="text-gray-300 data-[state=active]:bg-gray-800">
                  Failed
                </TabsTrigger>
              </TabsList>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm text-gray-400 capitalize">{report.type}</span>
                            </div>
                            <div>
                              <h3 className="text-lg font-medium text-gray-100">{report.title}</h3>
              ...
              <TabsContent value="generating">
                <div className="grid gap-4">
                  {filteredReports.filter(r => r.status === "generating").map((report) => (
                    <Card key={report.id} className="bg-gray-900 border-gray-800">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
              ...
              <TabsContent value="failed">
                <div className="grid gap-4">
                  {filteredReports.filter(r => r.status === "failed").map((report) => (
                    <Card key={report.id} className="bg-gray-900 border-gray-800">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
