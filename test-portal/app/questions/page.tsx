...
interface Question {
  id: string
  title: string
  type: "multiple-choice" | "true-false" | "short-answer" | "essay" | "coding" | "fill-blank"
  category: string
...
export default function QuestionsPage() {
  ...
  const questions: Question[] = [
    ...
    },
    {
      ...
      difficulty: "medium",
      status: "active",
      content: "Write a Python list comprehension to create a list of squares from 0 to 9.",
      correctAnswer: "[x**2 for x in range(10)]",
      explanation: "List comprehension provides a concise way to create lists. [x**2 for x in range(10)] generates squares of numbers 0 through 9.",
    ...
    },
    {
      ...
      explanation: "Photosynthesis involves chlorophyll capturing light energy to convert CO2 and water into glucose and oxygen.",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "The ozone layer is located in the stratosphere, approximately 15-35km above Earth's surface.",
    ...
    },
    {
      ...
      difficulty: "hard",
      status: "archived",
      content: "Discuss the importance of database normalization and explain the first three normal forms with examples.",
      correctAnswer: "Database normalization is the process of organizing data to reduce redundancy...",
      explanation: "Normalization helps eliminate data redundancy and improve data integrity. 1NF, 2NF, and 3NF are the most common forms.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-400">Total Questions</CardTitle>
              <BookOpen className="h-4 w-4 text-gray-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-light text-gray-100">{questions.length}</div>
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-400">Active Questions</CardTitle>
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-400">Avg Usage</CardTitle>
              <TrendingUp className="h-4 w-4 text-gray-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-light text-gray-100">
                {Math.round(questions.reduce((acc, q) => acc + q.usageCount, 0) / questions.length)}
              </div>
          ...
          <Card className="bg-gray-900 border-gray-800">
            ...
            <CardContent>
              <div className="text-2xl font-light text-gray-100">{allCategories.length}</div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-lg font-medium text-gray-100">{question.title}</h3>
                      <Badge variant="outline" className={`text-xs ${getTypeColor(question.type)}`}>
                        {question.type.replace('-', ' ')}
                      </Badge>
                      <Badge variant="outline" className={`text-xs ${getStatusColor(question.status)}`}>
                      ...
                      {question.timeLimit && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-gray-400">{question.timeLimit}s</span>
                        </div>
                      )}
                    </div>
                    
                    <p className="text-sm text-gray-300 mb-4">{question.content}</p>
                    ...
                    <div className="flex items-center gap-6 text-xs text-gray-400">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className={getScoreColor(question.averageScore)}>
                          {question.averageScore > 0 ? `${question.averageScore}% avg score` : 'Not used yet'}
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
